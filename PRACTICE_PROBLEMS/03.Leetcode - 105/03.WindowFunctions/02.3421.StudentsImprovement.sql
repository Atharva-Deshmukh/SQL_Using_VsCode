...
FROM (
    SELECT
        ...
        FIRST_VALUE(score) OVER (
            ...
            ORDER BY exam_date        -- I missed this, order should be by exam date, I used ASC
        ) AS first_score,

        FIRST_VALUE(score) OVER (     --   AVOID LAST_VALUE, we can use first value only
            PARTITION BY student_id, subject
