...
I was stuck at the ranking part, the 4th CTE logic
...
-- aggregate each category within each season
seasonWiseCategory AS (

    SELECT season,
           category,
           SUM(quantity) AS total_quantity,
           SUM(quantity * price) AS total_revenue
    FROM seasonAddedToJoinedTables
    GROUP BY season, category

),

-- rank categories within each season  --  I WAS STUCK HERE
rankedCategories AS (
